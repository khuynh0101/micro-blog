const formatDate = (dateinMilliseconds) => {
  ...
  console.log(
   ...
   if (diffInSeconds >= 86400000 && diffInSeconds < 172800000) return '1 day ago';
  
  const date = new Date(1592439936904);
  console.log(date);
  ...
  return date.toLocaleString('default', { month: 'long' }) + " " + date.getDate() + ", " + date.getFullYear() + "  " + strTime;
};
